    ...
    <section id={scss.footer}>
      <div className="container">
        ...
        <div className={scss.footer4}>
          <h3>Контакты</h3>
          <p><span><GoMail /></span>@motionwebteam@gmail.com</p>
          <p><span><IoCallOutline /></span>+996 559 - 69 - 26 - 26</p>
        </div>

        <div className={scss.footer5}>
          <h3>Адреса</h3>
          <p><span><IoLocationOutline /></span>Турусбекова 109 / 3</p>
